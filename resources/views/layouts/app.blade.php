...
<html>
<head>
<title>UdemyLaravel Kitap Sitesi</title>
...
<body>
			...
			<div class="top-header-main">
				<div class="col-md-6 top-header-left">
					<div class="drop">
						...
						<div class="box">
							<a href="{{route('logout')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="color:white">Çıkış Yap</a>
	...
	<!--start-logo-->
	<div class="logo">
		<a href="{{route('index')}}"><h1>Kitap Dünyası</h1></a>
	</div>
	<!--start-logo-->
	<!--bottom-header-->
